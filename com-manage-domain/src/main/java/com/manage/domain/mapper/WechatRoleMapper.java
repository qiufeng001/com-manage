 ...
 * @author zhong.h
 */
public interface WechatRoleMapper {
    /**
     * 根据条件分页查询角色数据
     *
     * @param role 角色信息
     ...
     * @return 角色列表
     */
    public List<WechatRole> selectRolePermissionByUserId(Long userId);
     ...
     * @return 角色列表
     */
    public List<WechatRole> selectRolesByUserName(String userName);
     ...
     * @return 角色信息
     */
    public WechatRole checkRoleNameUnique(String roleName);
     ...
     * @return 角色信息
     */
    public WechatRole checkRoleKeyUnique(String roleKey);
