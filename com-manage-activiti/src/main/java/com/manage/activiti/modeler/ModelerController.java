package com.manage.activiti.modeler;
...
public class ModelerController extends BaseController {
    ...
    public TableDataInfo list(ModelEntityImpl modelEntity) {
        ...
        // 条件过滤
        if (com.manage.common.core.utils.StringUtils.isNotBlank(modelEntity.getKey())) {
            modelQuery.modelKey(modelEntity.getKey());
        }
        if (com.manage.common.core.utils.StringUtils.isNotBlank(modelEntity.getName())) {
        ...
        Page<ModelEntityImpl> list = new Page<ModelEntityImpl>();
    ...
    public AjaxResult create(@RequestParam("name") String name, @RequestParam("key") String key,
        ...
        try {
            ...
            repositoryService.addModelEditorSource(newModel.getId(), editorNode.toString().getBytes(Charset.forName("UTF-8")));
