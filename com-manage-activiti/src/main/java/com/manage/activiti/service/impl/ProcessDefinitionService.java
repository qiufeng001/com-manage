package com.manage.activiti.service.impl;
...
public class ProcessDefinitionService implements IProcessDefinitionService {
     ...
     */
    @Override
    public Page<com.manage.activiti.domain.ProcessDefinition> listProcessDefinition(com.manage.activiti.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.manage.activiti.domain.ProcessDefinition> list = new Page<com.manage.activiti.domain.ProcessDefinition>();
        ...
        for (ProcessDefinition definition : processDefinitionList) {
            ...
            com.manage.activiti.domain.ProcessDefinition entity = new com.manage.activiti.domain.ProcessDefinition();
